        ...
        <div className="container mx-auto">
          <div className="mx-auto mt-20 grid grid-cols-1 gap-6 px-4 pb-14 md:grid-cols-2 lg:grid-cols-3">
            {activities
              ...
              .map((activity) => {
                const liked = wishlist.some((w) => w.id === activity.id);
                return (
                  <div
                    key={activity.id}
                  ...
                  >
                    ...
                    <div className="relative h-64">
                      ...
                      <button
                        className="absolute top-3 left-3 rounded-full bg-[#223B7D] p-2 text-white"
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      ...
                      <div className="mt-auto flex gap-3">
                        ...
                        <button
                          ...
                          className="rounded-lg border border-[#223B7D] p-3 hover:bg-gray-50"
                        >
