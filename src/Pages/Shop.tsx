...
//   const [searchTerm, setSearchTerm] = useState("");
//   const [company, setCompany] = useState("");
//   const [priceRange, setPriceRange] = useState(""); // ✅ New Price Filter State
//   const [visibleCount, setVisibleCount] = useState(9);
//   const loadMoreCount = 6;
...
//     let matchesCompany = !company || product.affiliated_company === company;
//     let matchesSearch =
//       !searchTerm ||
...
//     else if (priceRange === "high") matchesPrice = product.price > 50;
