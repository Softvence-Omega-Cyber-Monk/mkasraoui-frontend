...
export default function SignUp() {
  ...
  const validateAddress = (address: string): string => {
    if (!address.trim()) return "Postal address is required";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Your registration has been successful. Please Log in now");
      navigate("/auth/login");
    } catch (error) {
      alert(error);
      console.error(error);
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border py-3 pr-4 pl-10 transition-all duration-200 focus:ring-2 focus:outline-none ${errors.name
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border py-3 pr-4 pl-10 transition-all duration-200 focus:ring-2 focus:outline-none ${errors.email
                    ? "border-red-300 focus:border-red-500 focus:ring-red-200"
                    : "border-gray-300 focus:border-blue-500 focus:ring-blue-200"
                    }`}
                />
              ...
              <div className="flex gap-2">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border py-3 pr-4 pl-10 transition-all duration-200 focus:ring-2 focus:outline-none ${errors.phone
                      ? "border-red-300 focus:border-red-500 focus:ring-red-200"
                      : "border-gray-300 focus:border-blue-500 focus:ring-blue-200"
                      }`}
                  />
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className={`w-full rounded-lg border px-10 py-2.5 text-sm transition-all duration-200 focus:ring-2 focus:outline-none ${errors.address
                  ? "border-red-300 focus:border-red-500 focus:ring-red-200"
                  : "border-gray-300 focus:border-blue-500 focus:ring-blue-200"
                  }`}
              />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border py-3 pr-12 pl-10 transition-all duration-200 focus:ring-2 focus:outline-none ${errors.password
                    ? "border-red-300 focus:border-red-500 focus:ring-red-200"
                    : "border-gray-300 focus:border-blue-500 focus:ring-blue-200"
                    }`}
                />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border py-3 pr-12 pl-10 transition-all duration-200 focus:ring-2 focus:outline-none ${errors.confirmPassword
                    ? "border-red-300 focus:border-red-500 focus:ring-red-200"
                    : "border-gray-300 focus:border-blue-500 focus:ring-blue-200"
                    }`}
                />
            ...
            <button
              ...
              className={`w-full cursor-pointer rounded-lg px-4 py-3 font-medium text-white transition-all duration-200 ${isSubmitting
