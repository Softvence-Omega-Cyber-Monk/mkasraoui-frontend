...
const AdminUpdateProfile: React.FC = () => {
...
//   return (
//     <div className="mx-auto mt-10 w-full max-w-lg rounded-2xl border border-gray-200 bg-white shadow-md">
...
//           type="submit"
//           disabled={isUpdating}
//           className="mt-4 w-full rounded-md bg-blue-700 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-800 disabled:opacity-50"
//         >
//           {isUpdating ? "Updating..." : "Update Profile"}
//         </button>
//       </form>
