...
//     setFormData((prev) => ({
//       ...prev,
//       files: [...prev.files, ...selectedFiles].slice(0, 5), // keep max 5 files
//     }));
...
//                       <button
//                         onClick={() => setViewProduct(product)}
//                         className="flex cursor-pointer items-center gap-2 rounded-lg bg-[#0F1F4C] px-3 py-2 text-sm font-medium text-white shadow-md transition-all duration-200 hover:bg-[#02133f] hover:from-red-600 hover:to-red-700 hover:shadow-lg focus:ring-2 focus:outline-none"
//                       >
//                         <GrView className="h-4 w-4" />
//                       </button>
//                     </td>
...
//                       setFormData({ ...formData, product_type: e.target.value })
//                     }
//                     className="w-full cursor-pointer rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 placeholder-gray-400 transition outline-none focus:border-blue-500 focus:ring focus:ring-blue-100"
//                   >
//                     <option value="">Select Product Type</option>
//                     <option value="DIY_BOX">DIY Box</option>
