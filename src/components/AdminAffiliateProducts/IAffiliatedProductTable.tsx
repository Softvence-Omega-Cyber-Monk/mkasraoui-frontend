        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            ...
            <button
              onClick={() => setPage((p) => Math.max(1, p - 1))}
              disabled={page <= 1}
              className="cursor-pointer rounded-md border border-gray-300 px-3 py-1.5 text-sm font-medium text-gray-700 transition-all duration-200 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50"
            >
              ← Prev
            </button>
              ...
              return pages.map((num, idx) =>
                num === "..." ? (
                  ...
                  <button
                    ...
                    className={`cursor-pointer rounded-md border px-3 py-1.5 text-sm font-medium transition-all duration-200 ${
                      num === page
...
// interface AffiliatedProductFormType {
//   title: string;
//   price: string; // string to allow commas
//   avgRating: number;
//   totalRatings: number;
//   image_url: string;
//   affiliated_company: string;
...
//                   },
//                 },
//                 { name: "avgRating", label: "Average Rating", type: "number", min: 0, max: 5, step: 0.1 },
//                 { name: "totalRatings", label: "Total Ratings", type: "number", min: 0 },
//                 { name: "image_url", label: "Image URL", type: "text" },
//                 { name: "affiliated_company", label: "Company", type: "text" },
//                 { name: "link", label: "Link", type: "text" },
//               ].map((field) => (
...
//                     min={field.min}
//                     max={field.max}
//                     {...register(field.name as keyof AffiliatedProductFormType, {
//                       required: `${field.label} is required`,
//                       pattern: field.pattern,
//                     })}
//                     className="rounded border border-gray-300 p-2"
...
//                   {errors[field.name as keyof AffiliatedProductFormType] && (
//                     <span className="text-sm text-red-500">
//                       {errors[field.name as keyof AffiliatedProductFormType]?.message}
//                     </span>
//                   )}
//                 </div>
//               ))}
