...
export default function Testimonials() {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative container mx-auto mt-10 overflow-hidden px-4 py-10 sm:py-12 md:mt-14 md:py-16 lg:px-5"
    >
      ...
      <div className="mx-auto max-w-6xl text-center">
        ...
        {/* Title */}
        <h2 className="testimonials-title font-fredoka mb-10 text-4xl leading-snug font-semibold text-[#191919] sm:mb-16 sm:leading-tight xl:text-5xl">
