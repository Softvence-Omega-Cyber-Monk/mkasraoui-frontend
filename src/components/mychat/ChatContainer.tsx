...
//   // 🔹 Responsive state for mobile drawer
//   const [showSidebar, setShowSidebar] = useState(false);

//   // 🔹 Auto-hide sidebar when conversation selected (on mobile)
//   useEffect(() => {
...
//   // 🔹 Render
//   return (
//     <div className="relative flex h-[calc(100vh_-_100px)] border border-[#DBE0E5] rounded-lg overflow-hidden bg-white">
//       {/* 🟦 Sidebar (Conversation List) */}
//       <div className="hidden md:flex w-64 border-r border-[#DBE0E5] flex-col">
//         <ConversationList
...
//       <div
//         className={`fixed top-0 right-0 h-full w-64 bg-white border-l border-[#DBE0E5] shadow-lg transform transition-transform duration-300 z-50 md:hidden ${
...
//         {/* Header */}
//         <div className="p-4 border-b border-[#DBE0E5] bg-white font-semibold text-lg flex items-center justify-between">
//           <div>
//             {currentPartnerName}
//             {connected ? (
...
useEffect(() => {
  ...
  // 🔹 Render
  return (
    <div className="flex h-[calc(100vh_-_100px)] border  border-[#DBE0E5] rounded-lg overflow-hidden   bg-white">
      {/* Sidebar */}
      <ConversationList
        conversations={conversationListProps}
        selectedId={selectedConversationId ?? undefined}
