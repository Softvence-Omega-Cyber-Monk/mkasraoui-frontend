      ...
      <div className="container mx-auto mt-6 flex flex-col items-center gap-4 rounded-xl bg-white p-4 shadow-md sm:flex-row sm:items-start sm:gap-4">
        ...
        <div className="relative w-full flex-1">
          <input
            ...
            className="w-full rounded-lg border border-gray-200 py-2 px-4 text-gray-700 placeholder-gray-400 focus:border-gray-300 focus:ring-1 focus:ring-gray-300 focus:outline-none"
          />
        </div>
        ...
        <div className="relative w-full sm:w-[140px]">
          <select
            value={selectedBadge}
            onChange={(e) => { setSelectedBadge(e.target.value); setPage(1); }}
        ...
        {paginatedBlogs.map((item) => (
          ...
          >
            ...
            <div className="flex-1 p-4">
              <h3 className="mb-2 line-clamp-2 text-lg font-medium">{item.title}</h3>
              <p className="mb-4 line-clamp-3 text-sm text-[#5A5C5F]">{item.description}</p>
              ...
              <div className="mb-3 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <img src={userCicler} alt="author" className="h-5 w-5 rounded-full" />
                  <span className="text-sm font-medium text-[#5A5C5F]"> admin</span>
                </div>
            ...
            <div className="mt-auto p-4 pt-0">
              <Link to={`/home/blog/${item.id}`}>
                <button className="flex w-full cursor-pointer hover:cursor-pointer items-center justify-center gap-2 rounded-md bg-[#223B7D]  px-4 py-3 text-sm text-white hover:bg-[#343f5c]">
                  Read Blog
