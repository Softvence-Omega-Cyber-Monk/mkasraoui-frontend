...
//   return (
//     <nav className="fixed top-0 left-0 z-50 w-full border-b border-gray-200 bg-white/80 shadow-md backdrop-blur-md">
//       <div className="container mx-auto flex max-w-[1640px] items-center justify-between px-4 lg:px-5">
//         {/* Logo */}
//         <Link to="/">
