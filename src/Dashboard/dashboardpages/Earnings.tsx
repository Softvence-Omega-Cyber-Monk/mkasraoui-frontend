...
function Earnings() {
  ...
  const paymentMethods = [
    ...
    { name: "PayPal", detail: "jane.doe@gmail.com", icon: <SlPaypal className="text-2xl" /> },
    { name: "Stripe", detail: "Stripe", icon: <PiStripeLogo className="text-2xl" /> },
  ];
  ...
  const { data: dashboardLink, isFetching: dashboardLoading } = useLoginDashboardQuery();
        ...
        <div className="mb-8">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {/* Go to Onboarding */}
              <button
  className={`flex items-center justify-center px-4   py-2 rounded-md text-white text-sm font-medium transition hover:shadow-md ${
    onboardingLink?.url
      ? "bg-[#223B7D] cursor-pointer  hover:bg-[#02195a]"
...
>
  ...
  <ArrowTopRightOnSquareIcon className="h-4 w-4 ml-1" />
        ...
        <div className="mb-8">
          ...
          {/* Withdraw Button */}
          <button className="hover:bg-secondary-dark bg-[#0D80F2]  cursor-pointer rounded-xl  px-6 py-3 text-sm font-medium text-white transition-colors">
            Withdraw Funds
          </button>
        </div>
