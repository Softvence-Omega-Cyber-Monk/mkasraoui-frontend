...
import { AlertCircle, Image, Loader2, MoreHorizontal, Paperclip, Search, Send, Smile } from 'lucide-react';
  ...
  1: [
    {
      id: 1,
      senderId: 1,
      content: "Hi there! I'm planning a birthday party for my daughter on July 20th and I'm looking for a caterer. My budget is around $500. Can you help?",
      timestamp: '2:30 PM',
      type: 'text',
      isOwn: false,
      status: 'read'
    },
    {
      id: 2,
      senderId: 0,
      content: "Hi Sophia, I'd be happy to help! Could you tell me more about the party? How many guests are you expecting?",
      timestamp: '2:35 PM',
      type: 'text',
      isOwn: true,
      status: 'read'
    },
    {
      id: 3,
      senderId: 1,
      content: "We're expecting about 15 kids and 10 adults. It's going to be at our backyard from 3 PM to 6 PM.",
      timestamp: '2:38 PM',
      type: 'text',
      isOwn: false,
      status: 'read'
    },
    {
      id: 4,
      senderId: 0,
      content: "Here's a menu with a variety of options. Let me know what you think!",
      timestamp: '2:42 PM',
      type: 'text',
      isOwn: true,
      status: 'read'
...
const Avatar: React.FC<{
  ...
  return (
    <div className="relative">
      <div className={`${sizeClasses[size]} rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold overflow-hidden`}>
        {src ? (
          <img
            src={src}
            alt={name}
...
const ContactItem: React.FC<{
  ...
  <div
    className={`flex items-center space-x-4 p-4 mx-1 rounded-xl cursor-pointer transition-all duration-200 ${
...
const MessageBubble: React.FC<{ message: Message }> = ({ message }) => {
  ...
  return (
    <div className={`flex ${message.isOwn ? 'justify-end' : 'justify-start'} mb-6`}>
      <div className="flex items-end space-x-3 max-w-md lg:max-w-lg">
  ...
  return (
    <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-white">
      <div className="flex items-center space-x-4">
        <Avatar name={contact.name} src={contact.avatar} size="lg" isOnline={contact.isOnline} />
        <div>
...
const MessageInput: React.FC<{
  ...
  const handleFileUpload = useCallback((e: React.ChangeEvent<HTMLInputElement>, type: 'file' | 'image') => {
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 flex items-center space-x-3">
          <input
            ...
            className="flex-1 px-5 py-3 bg-gray-50 border-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white text-sm"
            disabled={isLoading}
          />
          <button
            onClick={handleSend}
...
const Messages: React.FC = () => {
  ...
  const handleSendMessage = async (content: string, type: 'text' | 'image' | 'file' = 'text', file?: File) => {
    ...
    const newMessage: Message = {
      id: Date.now(),
      senderId: 0,
      content: file && (type === 'image' || type === 'file') ? URL.createObjectURL(file) : content,
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search..."
              className="w-full pl-12 pr-4 py-3 bg-gray-50 border-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white text-sm"
            />
          </div>
        </div>
